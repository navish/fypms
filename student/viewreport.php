      ...
      <div class="w3-card-2 w3-round">
        <div class="w3-white">
          ...
          <div id="Demo3" class="w3-hide w3-container">
              ...
              <p><a href=""><button class="w3-btn-block w3-grey w3-left-align"><i class="fa fa-save fa-fw w3-margin-right"></i> View Submitted Report </button></a></p>

              

              <p><a href=""><button class="w3-btn-block w3-grey w3-left-align"><i class="fa fa-upload fa-fw w3-margin-right"></i> Upload New Report </button></a></p>
        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              var_dump($report['report1']);
              var_dump($reportfile);
              $fileAddress = "../".$reportfile;
              var_dump($fileAddress);

              #$file = file_get_contents($fileAddress, FILE_USE_INCLUDE_PATH);
             # $file = file_get_contents('../reports/report.txt', FILE_USE_INCLUDE_PATH);
